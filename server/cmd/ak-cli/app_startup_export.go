...
func appStartupCommand(args []string) error {
	if len(args) == 0 || args[0] != "export" {
		return fmt.Errorf("usage: ak-cli app-startup export --app-id UUID --output DIR [--check]")
	}
...
// Generated by ak-cli app-startup export. Do not edit this file directly.
