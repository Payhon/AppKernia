...
var (
	...
	ErrCaptchaRequired     = errors.New("interactive captcha is required")
	ErrCaptchaInvalid      = errors.New("interactive captcha is invalid")
	ErrCaptchaCooldown     = errors.New("interactive captcha is cooling down")
	ErrCaptchaUnavailable  = errors.New("interactive captcha is unavailable")
