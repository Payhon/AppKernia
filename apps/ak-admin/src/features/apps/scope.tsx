...
const appScopedRoutes = new Set(["/app/feedbacks","/app/users", "/app/upgrade-center", "/system/mobile/releases", "/system/notifications/push-channels", "/system/notifications/operations"]);
