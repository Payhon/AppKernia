...
function expectedTag(path) {
  ...
  if (path === '/api/v1/me/login-methods' || path === '/api/v1/me/password' || path.startsWith('/api/v1/me/oauth-accounts') || path.startsWith('/api/v1/me/login-identifiers/')) return 'mobile-profile'
  ...
  if (path.startsWith('/admin-api/v1/login-provider-')) return 'admin-system-settings'
